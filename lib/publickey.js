...
var publicKeyClassCache = new WeakMap();

/**
 * Creates a PublicKey class bound to the given `Networks` instance. See
 ...
 * @returns {PublicKey}
 */
function createPublicKeyClass(Network) {
  if (publicKeyClassCache.has(Network)) {
    return publicKeyClassCache.get(Network);
  }

  function getAddress() {
    return require('./address').createAddressClass(Network);
  }
  ...
  PublicKey._isPrivateKey = function (param) {
    return param instanceof getPrivateKey();
  };
  ...
  PublicKey.prototype.toAddress = function (network) {
    return getAddress().fromPublicKey(this, network || this.network);
  };
  ...
  publicKeyClassCache.set(Network, PublicKey);

  return PublicKey;
}

module.exports = { createPublicKeyClass: createPublicKeyClass };
