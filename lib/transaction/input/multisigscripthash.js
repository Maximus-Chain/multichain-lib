...
var multiSigScriptHashInputClassCache = new WeakMap();

/**
 * Creates the MultiSigScriptHashInput class bound to the given `Networks`
 * instance.
 *
 * @param {Object} Networks - a `lib/networks.js` `createNetworks()` instance
 * @returns {MultiSigScriptHashInput}
 */
function createMultiSigScriptHashInputClass(Networks) {
  if (multiSigScriptHashInputClassCache.has(Networks)) {
    return multiSigScriptHashInputClassCache.get(Networks);
  }
  ...
  multiSigScriptHashInputClassCache.set(Networks, MultiSigScriptHashInput);

  return MultiSigScriptHashInput;
}

module.exports = {
  createMultiSigScriptHashInputClass: createMultiSigScriptHashInputClass,
};
