 ...
 */
function createProRegTxPayloadClass(Networks) {
  if (proRegTxPayloadClassCache.has(Networks)) {
    return proRegTxPayloadClassCache.get(Networks);
  }
  ...
  proRegTxPayloadClassCache.set(Networks, ProRegTxPayload);
