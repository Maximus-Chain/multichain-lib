  ...
  describe('DIP14 256-bit compliance', function () {
    it('should derive an arbitrary DIP14 256-bit path correctly from a seed', function () {
      var seededKey = HDPrivateKey.fromSeed(
        vector3_dip14_master,
        Networks.testnet
      );
      seededKey
        .deriveChild(vector3_dip14_path_1_m77)
        .privateKey.toString('hex')
        .should.equal(vector3_dip14_path_1_m77_private);
      seededKey
        .deriveChild(vector3_dip14_path_1_m77_f5h)
        .privateKey.toString('hex')
        .should.equal(vector3_dip14_path_1_m77_f5h_private);
      seededKey
        .deriveChild(vector3_dip14_path_1_m77_f5h_4c_0)
        .privateKey.toString('hex')
        .should.equal(vector3_dip14_path_1_m77_f5h_4c_0_private);
    });
    ...
    it('should serialize an arbitrary DIP14 256-bit xpubkey and xprivkey correctly', function () {
      ...
      seededKey
        .deriveChild(vector3_dip14_path_1_m77_f5h_4c_0)
        .xprivkey.should.equal(vector3_dip14_path_1_m77_f5h_4c_0_xprivkey);
      seededKey
        .deriveChild(vector3_dip14_path_1_m77_f5h_4c_0)
        .xpubkey.should.equal(vector3_dip14_path_1_m77_f5h_4c_0_xpubkey);
    });
    ...
    it('should return the same publicKey for non-hardened derivation from HDPrivateKey and HDPublicKey', function () {
      ...
      seededKey
        .deriveChild(vector3_dip14_path_1_m77)
        .publicKey.toString()
        .should.equal(vector3_dip14_path_1_m77_public);
      seededKey.hdPublicKey
        .deriveChild(vector3_dip14_path_1_m77)
        .publicKey.toString()
        .should.equal(vector3_dip14_path_1_m77_public);
    });
    ...
    it('should serialize the same xpubkey non-hardened derivation from HDPrivateKey and HDPublicKey', function () {
      ...
      seededKey
        .deriveChild(vector3_dip14_path_1_m77)
        .xpubkey.toString()
        .should.equal(vector3_dip14_path_1_m77_xpubkey);
      seededKey.hdPublicKey
        .deriveChild(vector3_dip14_path_1_m77)
        .xpubkey.toString()
        .should.equal(vector3_dip14_path_1_m77_xpubkey);
    ...
    it('should serialize 256-bit xpubkey and xprivkeys correctly for hardened and non-hardened derivations', function () {
      ...
      seededKey
        .deriveChild(vector3_dip14_path_1_m77)
        .xprivkey.should.equal(vector3_dip14_path_1_m77_xprivkey);
      seededKey
        .deriveChild(vector3_dip14_path_1_m77)
        .xpubkey.should.equal(vector3_dip14_path_1_m77_xpubkey);
      seededKey
        .deriveChild(vector3_dip14_path_1_m77_f5h)
        .xprivkey.should.equal(vector3_dip14_path_1_m77_f5h_xprivkey);
      seededKey
        .deriveChild(vector3_dip14_path_1_m77_f5h)
        .xpubkey.should.equal(vector3_dip14_path_1_m77_f5h_xpubkey);
    });
    ...
    it('should derive a Dashpay DIP14 256-bit path correctly from a seed', function () {
      ...
      seededKey
        .deriveChild(vector3_dip14_path_2)
        .privateKey.toString('hex')
        .should.equal(vector3_dip14_path_2_private);
    });
    ...
    it('should serialize a Dashpay DIP14 256-bit xpubkey and xprivkey correctly', function () {
      ...
      seededKey
        .deriveChild(vector3_dip14_path_2)
        .xprivkey.should.equal(vector3_dip14_path_2_xprivkey);
      seededKey
        .deriveChild(vector3_dip14_path_2)
        .xpubkey.should.equal(vector3_dip14_path_2_xpubkey);
    });
    ...
    it('should derive a BIP32 path from hex correctly', function () {
      ...
      child.privateKey
        .toString('hex')
        .should.equal(childHex.privateKey.toString('hex'));
...
var vector3_dip14_path_1_m77 =
  'm/0x775d3854c910b7dee436869c4724bed2fe0784e198b8a39f02bbb49d8ebcfc3b';
var vector3_dip14_path_1_m77_public =
  '03a2d1bbd1511e2bad8ed6292e949a97b42c29ce2438e39c93c46df2d283135ad3';
var vector3_dip14_path_1_m77_private =
  'f6a95ae75ea8362d9478932f71b262b3d981918fe030316686a475dea4889938';
var vector3_dip14_path_1_m77_xpubkey =
...
var vector3_dip14_path_1_m77_xprivkey =
...
var vector3_dip14_path_1_m77_f5h =
...
var vector3_dip14_path_1_m77_f5h_private =
  'b898ad92d3a0698bc3117d3777d82676673816ce52f4fc2f1263a2f676825f90';
var vector3_dip14_path_1_m77_f5h_xpubkey =
...
var vector3_dip14_path_1_m77_f5h_xprivkey =
...
var vector3_dip14_path_1_m77_f5h_4c_0 =
...
var vector3_dip14_path_1_m77_f5h_4c_0_private =
  'e8781fdef72862968cd9a4d2df34edaf9dcc5b17629ec505f0d2d1a8ed6f9f09';
var vector3_dip14_path_1_m77_f5h_4c_0_xprivkey =
  'tprv8iNr6Z8PgAHmYSgMKGbq42kMVAAQmwmzm5iTJdUXoxLf25zG3GeRCvnEdC6HKTHkU59nZkfjvcGk9VW2YHsFQMwsZrQLyNrGx9c37kgb368';
var vector3_dip14_path_1_m77_f5h_4c_0_xpubkey =
  'tpubDF4tEyAdpXySRui9CvGRTSQU4BgLwGxuLPKEb9WqEE93raF2ffU1PRQ6oJHCgZ7dArzcMj9iKG8s8EFA1DdwgzWAXs61uFuRE1bQi8kAmLy';

var vector3_dip14_path_2 =
...
var vector3_dip14_path_2_private =
  'fac40790776d171ee1db90899b5eb2df2f7d2aaf35ad56f07ffb8ed2c57f8e60';
var vector3_dip14_path_2_xprivkey =
  'tprv8p9LqE2tA2b94gc3ciRNA525WVkFvzkcC9qjpKEcGaTqjb9u2pwTXj41KkZTj3c1a6fJUpyXRfcB4dimsYsLMjQjsTJwi5Ukx6tJ5BpmYpx';
var vector3_dip14_path_2_xpubkey =
...
var vector3_bip32_private =
  '610c2ef3000e75ec04e78b4d9b016aad3e275bf17edb30087d6fa1299938cf0d';
