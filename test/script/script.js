...
describe('Script', function () {
  ...
  describe('#buildPublicKeyHashOut', function () {
    it('should create script from livenet address', function () {
      var address = Address.fromString('MAmVFE7JMqKHM36Wu3BK2saPW8YAZEFrMe');
      var s = Script.buildPublicKeyHashOut(address);
      should.exist(s);
      s.toString().should.equal(
        'OP_DUP OP_HASH160 20 0x1f74ebe8fc4ae2bb7d343fdda717a8df81d2b104 OP_EQUALVERIFY OP_CHECKSIG'
      );
      s.isPublicKeyHashOut().should.equal(true);
      s.toAddress()
        .toString()
        .should.equal('MAmVFE7JMqKHM36Wu3BK2saPW8YAZEFrMe');
    });
    it('should create script from testnet address', function () {
      var address = Address.fromString('mQHpZJFkGyv6oJxhqb8qqyPUmMb6WHNd6v');
      var s = Script.buildPublicKeyHashOut(address);
      should.exist(s);
      s.toString().should.equal(
        'OP_DUP OP_HASH160 20 0x58fa3f407ec064175b0ddcc6ee10b15de5fd1601 OP_EQUALVERIFY OP_CHECKSIG'
      );
      s.isPublicKeyHashOut().should.equal(true);
      s.toAddress()
        .toString()
        .should.equal('mQHpZJFkGyv6oJxhqb8qqyPUmMb6WHNd6v');
    });
  ...
  describe('#buildScriptHashOut', function () {
    ...
    it('inherits network property from other script', function () {
      var s1 = new Script.fromAddress(
        new Address('MAmVFE7JMqKHM36Wu3BK2saPW8YAZEFrMe')
      );
    ...
    it('inherits network property form an address', function () {
      var address = new Address('35pL4ozcAwczeM6qQTBDBeEmtADdSncvgb');
  ...
  describe('getData returns associated data', function () {
    ...
    it('for a P2SH address', function () {
      var address = Address.fromString('35pL4ozcAwczeM6qQTBDBeEmtADdSncvgb');
  ...
  describe('toAddress', function () {
    ...
    it('for a P2PKH address', function () {
      var stringAddress = 'MAmVFE7JMqKHM36Wu3BK2saPW8YAZEFrMe';
      var address = new Address(stringAddress);
      var script = new Script(address);
      script.toAddress().toString().should.equal(stringAddress);
    });
    it('for a P2SH address', function () {
      var stringAddress = '35pL4ozcAwczeM6qQTBDBeEmtADdSncvgb';
      var address = new Address(stringAddress);
      var script = new Script(address);
      script.toAddress().toString().should.equal(stringAddress);
    });
    ...
    it('works for p2pkh output', function () {
      ...
      script
        .toAddress()
        .toString()
        .should.equal('MSDK3QxzkJJQuZ4fzhLdXrQmhVqCwLgzRh');
    });
    it('works for p2pkh input', function () {
      ...
      s2.toAddress()
        .toString()
        .should.equal('MEPL5wzfvFGWz2UCqA8W3oZ3ZbawsB6eYN');
    });
